...
public class detail_musik1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_musik1);

        btnSewa = (Button) findViewById(R.id.sewa);
        btnSewa.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(detail_musik1.this, FormSewa.class));
            }
        });
    }

    public void satu(View view) {
        Intent i = new Intent(detail_musik1.this, kematian.class);
        startActivity(i);
    }
